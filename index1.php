...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $base_url?>css/bootstrap-glyphicons.css">
    <!--Script-->
...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo $base_url?>live_results">Live Results</a></li>
                ...
                <div style="padding-top: 5%">
                    ...
                    else
                    {
                        ...
                        <table class="table  table-hover table-striped">
                            ...
                            foreach ($capitalList as $key=>$capItem) {
                            echo($key." => ".$capItem);
                            echo("==>>> ".$capItem['id']." VALUE HERE...");
                                ?>
                                <tr>
                ...
                $(function(){
                    $( "#capDateForm" ).click(function(event)
                    {
                        ...
                        $.ajax(
                            {
                                type:"post",
                                url: "<?php echo $base_url; ?>ajax.php?ajaxCapital",
                                data:{ date:date},
                                dataType:"json",
                    ...
                    $(function(){
                        $( "#rdDateForm" ).click(function(event)
                        {
                            ...
                            $.ajax(
                                {
                                    type:"post",
                                    url: "<?php echo $base_url; ?>ajax.php?ajaxRoyal",
                                    data:{ date:date},
                                    dataType:"json",
                                    success:function(data)
                                    {
